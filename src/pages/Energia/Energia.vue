...
export default {
  ...
  methods: {
    ...
    loadData(){
      axios.get(config.hostname+'expediente/obtener_expediente_area/4/'+this.page+'/'+this.perpage)
      .then( (response) =>{
        this.showTable = true;
        this.loadingTable = false;
        this.showTable = true;
    ...
    loadPerPage(perpage){
      this.page = 1;
      axios.get(config.hostname+'expediente/obtener_expediente_area/4/1/'+perpage)
      .then( (response) =>{
        this.expedientes = response.data.data;
      })
      .catch( (error) =>{
    ...
    loadPage(page){
      axios.get(config.hostname+'expediente/obtener_expediente_area/4/'+page+'/'+this.perpage)
      .then( (response) =>{
